...
// Code created by Rozebud for FPS Plus (thanks rozebud also KadeDev)
// modified by KadeDev and also for me 
...
class KeyBindMenu extends FlxSubState
{
	...
	{	
        ...
        ControlsOptionsMenu.instance.acceptInput = false;
    ...
    function quit(){
        ...
        ControlsOptionsMenu.instance.acceptInput = true;
